...
If you'd like to contribute, start by searching through the [issues](https://github.com/sparkfun/SparkFun_Auto_pHAT/issues) and [pull requests](https://github.com/sparkfun/SparkFun_Auto_pHAT/pulls) to see whether someone else has raised a similar idea or question.
